...
abstract class AppLocalizations {
  ...
  /// No description provided for @message_input_hint.
  ///
  /// In en, this message translates to:
  /// **'Ask something...'**
  String get message_input_hint;
  ...
  /// No description provided for @active_chat.
  ///
  /// In en, this message translates to:
  /// **'Active Chat'**
  String get active_chat;

  /// No description provided for @active_chat_desc.
  ///
  /// In en, this message translates to:
  /// **'You already have an active chat, do you want to close it?'**
  String get active_chat_desc;
